...
//    private static final Logger log = LoggerFactory.getLogger(JsonUtils.class);
     ...
     * List<UserInfo> list = JsonUtils.json2GenericObject(jsonStr, new TypeReference<List<UserInfo>>() {});
     * 例2：String jsonStr = "[\"1111\",\"2222\",\"3333\"]";
     * List<String> list = JsonUtils.json2GenericObject(jsonStr, new TypeReference<List<String>>() {});
     * @param <T> 转换泛型
